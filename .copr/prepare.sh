...
git clone https://github.com/haircommander/cri-o
cd cri-o && git checkout 71e0ddf9c1fd9939de57a8964fb99b8b399f96cf && git archive --prefix "crio/" --format "tar.gz" HEAD -o "../build/crio.tar.gz"
