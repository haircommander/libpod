...
git clone https://github.com/haircommander/conmon-exec conmon
cd conmon && git checkout e69d9ee281cc0e43225fd72e2b71919be5f52c2c && git archive --prefix "conmon/" --format "tar.gz" HEAD -o "../build/conmon.tar.gz"
